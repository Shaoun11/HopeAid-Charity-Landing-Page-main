...
const Goal = () => {
    return (
        ...
        <div className='max-w-7xl mx-auto lg:ml-40 md:ml-6 md:mr-6 ml-0 mt-[120px] mb-[60px] md:flex lg:gap-20 gap-5 '>
            ...
            <div className='lg:p-6 p-3 border border-[#1717171F]'>
                <h1 className='lg:text-[40px] font-medium text-[32px] text-[#068278]'>56+</h1>
            ...
            <div className='lg:p-6 p-3 border border-[#1717171F]'>
                <h1 className='lg:text-[40px] font-medium text-[32px] text-[#068278]'>$103M</h1>
                <p className='lg:text-[15px] text-sm font-normal text-[#525252]'>
            ...
            <div className='lg:p-6 p-3 border border-[#1717171F]'>
                <h1 className='lg:text-[40px] font-medium text-[32px] text-[#068278]'>8M+</h1>
                <p className='lg:text-[15px] text-sm font-normal text-[#525252] '>
                Dedication to successful <span className='md:block '></span> charitable fundraising
                </p>
            </div>
            <div className='lg:p-6 p-3 border border-[#1717171F]'>
                <h1 className='lg:text-[40px] font-medium text-[32px] text-[#068278]'>900+</h1>
                <p className='lg:text-[15px] text-sm font-normal text-[#525252] '>
            ...
            <div className='lg:mt-0 md:mt-0 mt-8 lg:ml-8 ml-4 lg:mr-0 mr-4'>
                ...
                <p className='mt-3 text-[#525252] font-medium lg:text-[15px] md:text-[13px] text-sm'>
